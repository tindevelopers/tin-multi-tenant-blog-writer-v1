...
-- Note: We'll use a unique index instead of constraint for better PostgreSQL compatibility
...
-- Using partial unique index for PostgreSQL compatibility
